...
_Note: The cross-reference to the integration notes on overlapping-tick behavior is a placeholder and should be updated when the document is available._
